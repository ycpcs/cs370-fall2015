...
[David Babcock](http://faculty.ycp.edu/~dbabcock/), <dbabcock@ycp.edu>, KEC101 (815-6442) <br /> Office hours: M W 1-3PM; T R 8:30-9:30AM, or by appointment
...
All the labs and assignments are cross platform so you may use either Visual Studio 2013 (Windows), XCode (Mac), or command line (Linux). Refer to the [Resources](resources.html) page for installation instructions for the various external libraries needed for the course.
...
Please check the [course web page](<http://ycpcs.github.io/cs370-fall2014/>), regularly for important announcements.
